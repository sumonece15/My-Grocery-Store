package com.sumon.mygrocerystore.ui.category;
...
import com.sumon.mygrocerystore.adapters.NavCategoryAdapter;
...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        progressBar = root.findViewById(R.id.navCat_progressBar);
        progressBar.setVisibility(View.VISIBLE);
        //nav_category_Rec.setVisibility(View.GONE);

        nav_category_Rec = root.findViewById(R.id.nav_category_rec);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                nav_category_Rec.setVisibility(View.VISIBLE);
